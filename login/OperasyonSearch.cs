...
namespace login
{
    public partial class OperasyonSearch : Form
    {
        Graphics gr_graphics = default(Graphics);
        public OperasyonSearch()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            myclass.OperasyonAra(toad.Text);

            while (x)
            {
                ListViewItem item = new ListViewItem(OperasyonClass.mylist[i]);
        ...
        private void toad_Enter(object sender, EventArgs e)
        {
